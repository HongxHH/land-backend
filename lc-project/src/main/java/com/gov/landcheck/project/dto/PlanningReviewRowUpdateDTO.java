...
/**
 * 规划复核表行更新 DTO（动态字段；不可通过本接口修改 projectId/fileRecordId/planningReviewFormId）
 */
@Data
@Schema(description = "规划复核表行更新请求")
public class PlanningReviewRowUpdateDTO {

    @NotNull(message = "规划复核表行ID不能为空")
