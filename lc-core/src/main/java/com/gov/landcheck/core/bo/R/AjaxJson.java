...
public class AjaxJson extends LinkedHashMap<String, Object> implements Serializable {
    ...
    public static AjaxJson getError() {
        return new AjaxJson(CODE_ERROR, MessageConstant.OPERATE_FAILED, null, null);
    }
    ...
    public static AjaxJson getPageData(Long dataCount, Object data) {
        return new AjaxJson(CODE_SUCCESS, MessageConstant.SUCCESS, data, dataCount);
    }
    ...
    public static AjaxJson getByLine(int line) {
        if (line > 0) {
            return getSuccess(MessageConstant.SUCCESS, line);
        }
        return getError(MessageConstant.OPERATE_FAILED).setData(line);
    }
    ...
    public static AjaxJson getByBoolean(boolean b, String errorMsg) {
